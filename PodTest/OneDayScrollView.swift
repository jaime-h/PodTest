...
@IBDesignable
class OneDayScrollView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let myUrl: String = "https://grogdata.soest.hawaii.edu/poh/data/node-021/PH_EXT.json?minutes=1440"
