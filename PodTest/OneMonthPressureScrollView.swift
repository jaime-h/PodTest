//
//  OneMonthPressureScrollView.swift
//  PodTest
//
//  Created by Jaime Hernandez on 1/27/17.
...
@IBDesignable
class OneMonthPressureScrollView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let myUrl: String = "https://grogdata.soest.hawaii.edu/poh/data/location/makaha1/depth.json?minutes=43200&max_count=250"
        ...
        Alamofire.request(myUrl).validate().responseJSON { (responseData) -> Void in
            if ((responseData.result.value) != nil) {
                ...
                self.resData = swiftyJsonVar["ReceptionTime"].arrayObject as! [Double]
                self.phData = swiftyJsonVar["depth"].arrayObject as! [Double]
